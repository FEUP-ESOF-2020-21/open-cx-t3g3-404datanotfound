...
class JoinAnEvent extends StatefulWidget {
  JoinAnEvent({Key key, this.auth, this.map, this.userRole}) : super(key: key);
      ...
      return WillPopScope(
          ...
          child: Scaffold(
            ...
            body: Stack(
              children: <Widget>[
                Transform.translate(
                  offset: Offset(SizeConfig.screenWidth * 0.0,
                  ...
                  child: Center(
                    ...
                    children: <Widget>[
                      ...
                      Text(
                        "\n Ups! You don't have any active \n conference. Why don't you join one?",
                ...
                Transform.translate(
                  offset: Offset(SizeConfig.screenWidth * 133.0,
                      SizeConfig.screenHeight * 587.0),
                  child: SizedBox(
                    ...
                    child: Stack(
                      children: <Widget>[
                        ...
                        Pinned.fromSize(
                            bounds: Rect.fromLTWH(
                                SizeConfig.screenWidth * 26.5,
                                SizeConfig.screenHeight * 15.5,
                                SizeConfig.screenWidth * 96.0,
                                SizeConfig.screenHeight * 26.0),
                            size: Size(SizeConfig.screenWidth * 149.0,
                                SizeConfig.screenHeight * 57.0),
                            fixedWidth: true,
                            fixedHeight: true,
                ...
                Transform.translate(
                  offset: Offset(SizeConfig.screenWidth * 64.5,
                      SizeConfig.screenHeight * 145.5),
                  child: Text(
                    'Join one event now!',
                    style: TextStyle(
                      fontFamily: 'Roboto',
                          ...
                          child: new ListTile(
                            trailing: IconButton(
                                ...
                                onPressed: () {
                                  ...
                                  FirebaseDatabase
                                      .instance // update the map and rebuild
                                      .reference()
                                      .once()
